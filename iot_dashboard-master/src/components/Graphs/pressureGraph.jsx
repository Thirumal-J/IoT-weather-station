...
class pressureGraph extends Component {
  ...
  componentWillMount() {
    axios
      .get(PRESSURE_LAST24)
      .then((response) => {
        var hrsBtnSelected = document.getElementById("pres24hrs");
  ...
  getPressure(arg) {
    ...
    axios
      .get(serverUrl)
      .then((response) => {
        if (serverUrl === PRESSURE_LAST24) {
          var hrsBtnSelected = document.getElementById("pres24hrs");
          hrsBtnSelected.style.opacity = "0.5";
          var weekBtnSelected = document.getElementById("presLastWeek");
  ...
  render() {
    return (
      <div /* style={styles} */>
        <div>
          {" "}
          <canvas id="bar_l1_chart" width="400" height="300"></canvas>{" "}
        </div>
        <div>
          {" "}
          <Button
            ...
            id="presLastWeek"
            onClick={this.getPressure.bind(this, "Week")}
          ...
          <Button
            ...
            id="pres24hrs"
            onClick={this.getPressure.bind(this, "Last")}
            style={{ backgroundColor: "white" }}
          >
            Last 24hrs Graph
          </Button>
